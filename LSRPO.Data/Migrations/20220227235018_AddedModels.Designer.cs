...
namespace LSRPO.Data.Migrations
{
    ...
    [Migration("20220227235018_AddedModels")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LSRPO.Data.Models.NG_NP", b =>
                {
            ...
            modelBuilder.Entity("LSRPO.Data.Models.NO_TYPE", b =>
                {
            ...
            modelBuilder.Entity("LSRPO.Data.Models.NOT_PROCES_STATE", b =>
                {
            ...
            modelBuilder.Entity("LSRPO.Data.Models.NOT_PROCESS", b =>
                {
            ...
            modelBuilder.Entity("LSRPO.Data.Models.NOT_PULT", b =>
                {
            ...
            modelBuilder.Entity("LSRPO.Data.Models.NOT_STATUS", b =>
                {
            ...
            modelBuilder.Entity("LSRPO.Data.Models.NOT_STATUS_PHONE_STATE", b =>
                {
                    b.Property<byte>("ST_ID")
                        .HasColumnType("tinyint");
            ...
            modelBuilder.Entity("LSRPO.Data.Models.NOT_STATUS_STATE", b =>
                {
                    b.Property<byte>("ST_ID")
                        .HasColumnType("tinyint");
            ...
            modelBuilder.Entity("LSRPO.Data.Models.NOTIFY_OBJECT", b =>
                {
                    b.Property<int>("NO_ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LSRPO.Data.Models.NPR_TYPE", b =>
                {
                    b.Property<int>("NTP_ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LSRPO.Data.Models.STATUS_STATE", b =>
                {
                    b.Property<byte>("ST_ID")
                        .HasColumnType("tinyint");
            ...
            modelBuilder.Entity("LSRPO.Data.Models.NG_NP", b =>
                {
                    ...
                    b.HasOne("LSRPO.Data.Models.NOTIFY_OBJECT", "NOTIFY_OBJECT")
                        .WithMany("NG_NPS")
                        .HasForeignKey("NO_ID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("LSRPO.Data.Models.NOT_PROCESS", b =>
                {
                    b.HasOne("LSRPO.Data.Models.NPR_TYPE", "NPR_TYPE")
            ...
            modelBuilder.Entity("LSRPO.Data.Models.NOT_STATUS", b =>
                {
                    ...
                    b.HasOne("LSRPO.Data.Models.NOT_PROCESS", "NOT_PROCESS")
                        .WithMany("NOT_STATUS")
            ...
            modelBuilder.Entity("LSRPO.Data.Models.NOTIFY_OBJECT", b =>
                {
                    b.HasOne("LSRPO.Data.Models.NOT_PULT", "NOT_PULT")
